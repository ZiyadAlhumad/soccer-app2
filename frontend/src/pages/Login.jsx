    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '32px', textAlign: 'center' }}>
          <h1 style={{ margin: '0 0 8px', fontSize: '2rem', color: 'var(--dark)', fontWeight: '700' }}>Login</h1>
          <p style={{ margin: '0', color: 'var(--slate-600)', fontSize: '0.95rem', lineHeight: '1.6' }}>
            Sign in to your account to book stadiums
          </p>
        </div>
        ...
        <p style={{ marginTop: '24px', textAlign: 'center', color: 'var(--slate-600)', fontSize: '0.95rem' }}>
          ...
          <NavLink to="/register" style={{ color: 'var(--primary)', fontWeight: '600', textDecoration: 'none' }}>
            Register here
          </NavLink>
        </p>
      </div>
